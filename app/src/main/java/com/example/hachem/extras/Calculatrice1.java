...
public class Calculatrice1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calculatrice1);
        ...
        Button retour=(Button)findViewById(R.id.RetourCalc);
        ecran = (EditText) findViewById(R.id.EditText01);
        retour.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Calculatrice1.this, MainActivity.class));
                System.exit(0);
            }
        });
